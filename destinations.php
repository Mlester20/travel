...
<head>
    ...
    <title>Destinations | <?php include 'includes/title.php'; ?> </title>
...
<body class="bg-gray-50">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1593105544559-f0470f9c055e" alt="El Nido" class="w-full h-64 object-cover group-hover:scale-110 transition duration-300">
                    <div class="absolute top-4 right-4 bg-white/80 backdrop-blur-sm rounded-full px-4 py-1 text-sm font-medium text-travel-blue">
                        Beach
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1584958902498-0391eabc9f61" alt="Chocolate Hills" class="w-full h-64 object-cover group-hover:scale-110 transition duration-300">
                    <div class="absolute top-4 right-4 bg-white/80 backdrop-blur-sm rounded-full px-4 py-1 text-sm font-medium text-travel-blue">
                        Natural Wonder
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1577125305658-dee71d4ea1bb" alt="Mount Mayon" class="w-full h-64 object-cover group-hover:scale-110 transition duration-300">
                    <div class="absolute top-4 right-4 bg-white/80 backdrop-blur-sm rounded-full px-4 py-1 text-sm font-medium text-travel-blue">
                        Mountain
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden group">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1583149577728-9ab503747013" alt="Siargao" class="w-full h-64 object-cover group-hover:scale-110 transition duration-300">
                    <div class="absolute top-4 right-4 bg-white/80 backdrop-blur-sm rounded-full px-4 py-1 text-sm font-medium text-travel-blue">
                        Beach
                    </div>
                </div>
